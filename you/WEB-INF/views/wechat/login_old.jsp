...
<body>
	...
	<script type="text/javascript" src="${ctx}/public/lib/jquery-cookie/jquery.cookie.js"></script>
	<script type="text/javascript" src="${ctx}/public/lib/bootstrap/bootstrap.min.js"></script>
	<script type="text/javascript" src="${ctx}/public/lib/less/less.min.js"></script>
